...
class PasswordResetTests(TestCase):
    ...
    def test_form_inputs(self):
        """
        The view contains two inputs: csrf and email.
        """
...
class SuccessfulPasswordResetTests(TestCase):
    def setUp(self):
        email = 'john@doe.com'
        User.objects.create_user('john', email, '123abcdef')
        url = reverse('accounts:password_reset')
        self.response = self.client.post(url, {'email': email})

    def test_redirection(self):
        """
        A valid form submission redirects the user to 'password_reset_done'
        view.
        """
...
class InvalidPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        """
        Even invalid emails in the database should redirect the user to
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        """
        user = User.objects.create_user('john', 'john@doe.com', '123abcdef')
    ...
    def InvalidPasswordResetConfirmTests(TestCase):
        def setUp(self):
            """
            Invalidate the token by changing the password after creation.
            """
            user = User.objects.create_user('john', 'john@doe.com', '123abcdef')
